...
function ENT:Think()
        ...
        //print("I'm in sandbox and my health is:" .. self:Health() .. "\n" )
...
//Added NPCfind (may get expensive as have to check all ents with this method)
                ...
                for _, v in pairs( ents.GetAll() ) do
                        ...
                        if (v:IsNPC()) then
                                ...
                                */
                                ...
                                if (newdist < dist && (tarangle < 90)) && v:IsNPC() then
                                        ply = v
                                        dist = newdist
                                        //print ("NPC found " .. v:GetName() .. " tracking... \n")
                                end
                        end
...
function ENT:Track()
        ...
        if ((target:IsPlayer() or target:IsNPC()) && (!self:OnTarget(target))) then
                ...
                local aimpoint = (target:EyePos() - Vector(0,0,20))
